(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react-native'), require('react-native-fabric')) :
	typeof define === 'function' && define.amd ? define(['exports', 'react-native', 'react-native-fabric'], factory) :
	(factory((global.ReduxPersist = global.ReduxPersist || {}),global.ReactNative,global.ReactNativeFabric));
}(this, (function (exports,reactNative,Fabric) { 'use strict';

Fabric = 'default' in Fabric ? Fabric['default'] : Fabric;
...
function getStoredState(config, onComplete) {
  ...
  storage.getAllKeys(function (err, allKeys) {
    if (err) {
      reactNative.Alert.alert('redux-persist/getStoredState: Error in storage.getAllKeys');
    ...
    keysToRestore.forEach(function (key) {
      storage.getItem(createStorageKey(key), function (err, serialized) {
        if (err) {
          reactNative.Alert.alert('redux-persist/getStoredState: Error restoring data for key:' + key);
  ...
  function rehydrate(key, serialized) {
    ...
    try {
      ...
      reactNative.Alert.alert('redux-persist/getStoredState: Error in rehydrate restoring data for key:' + key);
